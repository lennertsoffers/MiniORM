...
public class Main {
    public static void main(String[] args) {
        ...
        Repository<TestClass> testClassRepository = new com.lennertsoffers.processor.test.TestClassBaseRepository();
        Repository<TestClassTwo> testClassTwoRepository = new com.lennertsoffers.processor.test.TestClassTwoBaseRepository();
        TestClass testClass1 = new TestClass("first_test_class");
        TestClass testClass2 = new TestClass("second_test_class");
        TestClassTwo tct1 = new TestClassTwo("tct1", 1.0f, 1.0, 1L, 1, true);
